 ...
 */
public class GuiCoinPouch extends GuiContainer
{
    ...
    public GuiCoinPouch(InventoryItemStackDynamic inventoryItem, InventoryPlayer playerInv, EnumHand hand)
    {
        super(new ContainerCoinPouch(playerInv, inventoryItem, Minecraft.getMinecraft().thePlayer, hand));
