...
//		if (this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ))).getMaterial() == Material.LAVA && !onLava) {
//			onLava = true;
...
//					{
//						player.addChatComponentMessage(new TextComponentString(ConfigHandler.wrongLocationMessagePalantir));
//					}
//				}
//			}
//		}
...
////						if (player != null)
////						{
////							EntityItem itemEntity = new EntityItem(worldObj, player.posX, player.posY, player.posZ, new ItemStack(TTFeatures.palantirShard));
////							itemEntity.delayBeforeCanPickup = 0;
////							worldObj.spawnEntityInWorld(itemEntity);
////						}
////						else
////						{
////							EntityItem itemEntity = new EntityItem(worldObj, posX, posY, posZ, new ItemStack(TTFeatures.palantirShard));
////							itemEntity.delayBeforeCanPickup = 0;
////							worldObj.spawnEntityInWorld(itemEntity);
////						}
////					}
...
//		}
		...
		if (!getOnLava() && worldObj.isMaterialInBB(this.getEntityBoundingBox().expand(-0.10000000149011612D, 0, -0.10000000149011612D), Material.LAVA)) {//this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ))).getMaterial() == Material.LAVA && !getOnLava()) {
			setOnLava();
			posY = MathHelper.floor_double(this.posY) + 0.9D;
