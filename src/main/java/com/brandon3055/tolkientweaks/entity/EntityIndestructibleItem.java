...
/**
 * Created by Brandon on 23/01/2015.
 */
public class EntityIndestructibleItem  extends EntityItem {
	public EntityIndestructibleItem(World par1World, double par2, double par4, double par6)
	{
	...
	public EntityIndestructibleItem(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack)
	{
	...
	public EntityIndestructibleItem(World par1World)
	{
		super(par1World);
		this.isImmuneToFire = true;
		this.lifespan = 72000;
	...
	public EntityIndestructibleItem(World world, Entity original, ItemStack stack)
	{
	...
	public void onUpdate() {
		...
		boolean flag2 = false;
		if (this.worldObj.getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY-1), MathHelper.floor_double(this.posZ)) == Blocks.end_portal) flag2 = true;
