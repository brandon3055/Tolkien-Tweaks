...
public class CommandCreate implements ISubCommand
{
	...
	public void handleCommand(EntityPlayer player, String[] args)
	{
		...
		if (args.length == 3 && args[2].equals("client") && TolkienTweaks.proxy.isDedicatedServer())
		{
			TolkienTweaks.network.sendTo(new PacketSchematicClient(args[1]), (EntityPlayerMP) player);
			return;
		}
